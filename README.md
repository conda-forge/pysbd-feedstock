...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysbd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14155&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysbd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysbd` can be installed with:

```
conda install pysbd
```

It is possible to list all of the versions of `pysbd` available on your platform with:
